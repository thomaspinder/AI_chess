...
class Parameters:
    ...
    # Agent Parameters
    end_games = dict(mate_in_1=['6k1/4Rppp/8/8/8/8/5PPP/6K1 w - - 0 1',
        ...
        #dict(mate_in_2=['2r1r1k1/5ppp/8/8/Q7/8/5PPP/4R1K1 w - - 0 1'],
        #             mate_in_3=['6k1/3qb1pp/4p3/ppp1P3/8/2PP1Q2/PP4PP/5RK1 w - - 0 1'])

    old_end_games = {'mate_in_1': ['6k1/4Rppp/8/8/8/8/5PPP/6K1 w - - 0 1',
